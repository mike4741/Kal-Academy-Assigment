#pragma checksum "C:\Users\rmisu\Documents\GitHub\Kal-Academy-Assigment\UWPPhotoLibrary\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "26023620F1FE32250234A1C73467E1D6"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWPPhotoLibrary
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 123 && columnNumber == 33)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 67 && columnNumber == 37)
                {
            ...
            private void Update_(global::UWPPhotoLibrary.Model1.Picture obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_AlbumCoverPhoto(obj.AlbumCoverPhoto, phase);
                    }
                }
            }
            private void Update_AlbumCoverPhoto(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 115 && columnNumber == 25)
                {
            ...
            case 10: // MainPage.xaml line 92
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.Button)element10).Click += this.NameButton_Click;
                }
                break;
