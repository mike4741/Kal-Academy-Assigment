#pragma checksum "C:\Users\rmisu\Documents\GitHub\Kal-Academy-Assigment\UWPPhotoLibrary\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "62AD7DD1257FBFEFB3560808764ECB19"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWPPhotoLibrary
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 117 && columnNumber == 40)
                {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 52 && columnNumber == 34)
                {
            ...
            private void Update_(global::UWPPhotoLibrary.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_CoverPicture(obj.CoverPicture, phase);
                        this.Update_menuItems(obj.menuItems, phase);
                        this.Update_DisplayPictures(obj.DisplayPictures, phase);
                    }
                }
            }
            private void Update_CoverPicture(global::System.Collections.ObjectModel.ObservableCollection<global::UWPPhotoLibrary.Model1.Picture> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
